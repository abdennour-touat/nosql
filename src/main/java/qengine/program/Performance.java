...
public class Performance {
    ...
    public static void main(String[] args) throws IOException {
        ...
        long myStoreTime = evaluatePerformance(myStore, integraalStore, starQueries, OUTPUT_DIR);
        System.out.println("MyStore Time: " + myStoreTime + "ms");
    }
    ...
    private static long evaluatePerformance(RDFHexaStore myStore, FactBase integraalStore, List<StarQuery> starQueries, String outputDir) throws IOException {
            long start = System.currentTimeMillis();
            for (StarQuery query : starQueries){
                List<Substitution> results = new ArrayList<>();
                myStore.match(query).forEachRemaining(results::add);
            }
            long end = System.currentTimeMillis();
            long myStoreTime = end - start;
            return myStoreTime;
    }
